...
$comlv += 2;
$comlv2 += 1;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc19.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
...
$comlv += 2;
$comlv2 += 1;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc20.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
...
$comlv += 2;
$comlv2 += 1;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc21.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
...
$comlv += 2;
$comlv2 += 1;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc22.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
...
$comlv += 2;
$comlv2 += 1;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc23.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
...
$comlv += 2;
$comlv2 += 1;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc24.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
...
$comlv += 2;
$comlv2 += 1;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc25.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
...
$comlv += 2;
$comlv2 += 1;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc26.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
...
$comlv += 2;
$comlv2 += 1;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc27.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
...
$i = 16;
$comlv += 2;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc16.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
...
$i = 17;
$comlv += 2;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc17.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
...
$i = 18;
$comlv += 2;
		open(IN,"./w_db/kuni/ctop$k_kunino{$fk_id} npc18.cgi");
		@NPCOP1 = <IN>;
		close(IN);
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
	...
	if ($in{'noks'} =~ m/[^0-9]/) {&ER1("通報しますた！"); }
	if ($in{'nokk'} =~ m/[^0-9]/) {&ER1("通報しますた！"); }
...
$hiti2 = $i;
$i = $hiti;
	if ($in{'noks'} ne "") {$nsaku3[$i] = $in{'noks'}; }
	if ($in{'nokk'} ne "") {$nkyou4[$i] = $in{'nokk'}; }
...
@new_charak=();
	...
	($nten1[$i],$nhyou2[$i],$nsaku3[$i],$nkyou4[$i],$ntt5[$i],$nnamae6[$i],$nkout7[$i],$nkatuk8[$i],$nkatut9[$i],$nteik10[$i],$nkyuuk11[$i],$nzei12[$i],$ndb13[$i],$ndb14[$i],$ndb15[$i],$ndb16[$i],$ndb17[$i],$nseikou18[$i],$ntuu19[$i],$nhit[$i]) = split(/<>/,$NPCOP1[0]);
						...
						}else{$comr = "提案内容が未設定です。来期の評定会議の方針を決めてください。";
						}
	$xx=0;
		$cnl = "";
	foreach(@t_name){
...
$comekk = "";
								if($comlv2){
$comrks .= "。国策：<select name=\".noks.\"><option value=\"61\">現状維持</option>";

	$xx=0;
	foreach(@KOKUSAKU){
		$comrks .= "<option value=\"$xx\">$KOKUSAKU[$xx]";
		$xx++;
	}
$comrks .= "</select>";
$KOKUSAKU[61] = "現状維持";
$comeks = "国策：$KOKUSAKU[$nsaku3[$i]]。";
								}

								if($comlv3){
$comrkk .= "。国教：<select name=\".nokk.\"><option value=\"61\">現状維持</option>";
	$xx=0;
	foreach(@KOKKYOU){
		$comrkk .= "<option value=\"$xx\">$KOKKYOU[$xx]</option>";
		$xx++;
	}
$comrkk .= "</select>";
$KOKKYOU[61] = "現状維持";
$comekk = "国教：$KOKKYOU[$nkyou4[$i]]。";
								}
								if($nhyou2[$i] eq "1"){
...
$comr = "国の総収入を１．５倍以上にする。税率：$nzei12[$i]";
								}elsif($nhyou2[$i] eq "4"){
...
$comr = "$k_name_d[$nteik10[$i]]に対しての交戦指定を取りやめ、目標を以下のように設定する。<br />
$t_name[$nkout7[$i]]の城を陥落させ、領土を増やす。税率：$nzei12[$i]";
								}elsif($nhyou2[$i] eq "13"){
$comr = "$k_name_d[$nteik10[$i]]に対しての交戦指定を取りやめ、目標を以下のように設定する。<br />
国の総収入を１．５倍以上にする。税率：$nzei12[$i]";
								}elsif($nhyou2[$i] eq "14"){
$comr = "$k_name_d[$nteik10[$i]]に対しての交戦指定を取りやめ、目標を以下のように設定する。<br />
大国に脅かされ窮地に陥っている盟友$k_name_d[$nkyuuk11[$i]]を護りとおす。税率：$add_busyou_kazei";
								}
$kikanks = 10 * $k_kokusaku_keika_nen{$fk_id};
$kikankk = 10 * $k_kokkyou_keika_nen{$fk_id};
$kikanks += $keika_nen % 10;
$kikankk += $keika_nen % 10;

$comsaku = "";
								if($k_kokusaku{$fk_id}){
$comsaku = "（発令期間：$kikanks年）";
								}

	&HEADER;
	print <<"PRI";

<span class=\"fs4\">$k_name{$fk_id}：評定会議場</span>
<hr /><br />次期評定・提案期限⇒$mwyear3年12月。<br />今期の攻略目標⇒$comk。国策：$KOKUSAKU[$k_kokusaku{$fk_id}]$comsaku。国教：$KOKKYOU[$k_kokkyou{$fk_id}]（布教期間：$kikankk年）。<br />貴方が提案する来期の攻略目標⇒$comr。$comeks$comekk<br />貴方の発言力⇒評定進言Lv$comlv。国策進言Lv$comlv2。国教進言Lv$comlv3。<br /><hr /><br /><strong>来期の評定会議における貴方の提案を入力してください。</strong>


<table border=\"1\" width=\"760\"><tr>
<td width=140>
『敵城攻略』</td><td width=\"610\"><form action=\"$COMMAND\" method=\"post\" utn=\"utn\"><div><input type=\"hidden\" name=\".m.\" value=\"hyoutei1\" /><input type=\"hidden\" name=\".i.\" value=\"$in{'i'}\" /><input type=\"hidden\" name=\".sakusen.\" value=\"1\" /><select name=\".cnot.\">$cnl
...
</select>$comrks$comrkk<input type=\"submit\" value=\"この案を選択\" /></div></form></td></tr><tr>

<td>
『敵城攻略＆領地割譲』</td><td><form action=\"$COMMAND\" method=\"post\" utn=\"utn\"><div><input type=\"hidden\" name=\".m.\" value=\"hyoutei1\" /><input type=\"hidden\" name=\".i.\" value=\"$in{'i'}\" /><input type=\"hidden\" name=\".sakusen.\" value=\"2\" /><select name=\".cnot.\">$cnl
</select><input type=\"hidden\" name=\".id.\" value=\"$in{'id'}\" /><input type=\"hidden\" name=\".pass.\" value=\"$in{'pass'}\" />の城を陥落させ、領土を増やす。
...
<td>
『収入アップ』</td><td><form action=\"$COMMAND\" method=\"post\" utn=\"utn\"><div><input type=\"hidden\" name=\".m.\" value=\"hyoutei1\" /><input type=\"hidden\" name=\".i.\" value=\"$in{'i'}\" /><input type=\"hidden\" name=\".sakusen.\" value=\"3\" /><input type=\"hidden\" name=\".id.\" value=\"$in{'id'}\" /><input type=\"hidden\" name=\".pass.\" value=\"$in{'pass'}\" />
内政を重視し、自国の総収入を１０年間で１．５倍以上にする。<br />武将に対する所得税率：<select name=\".cno.\"><option value=\"61\">現状維持</option><option value=\"1\">1％</option><option value=\"5\">5％</option><option value=\"10\">10％</option><option value=\"15\">15％</option><option value=\"20\">20％</option>
</select>$comrks$comrkk<input type=\"submit\" value=\"この案を選択\" /></div></form></td></tr><tr>

<td>
『事大政策』</td><td><form action=\"$COMMAND\" method=\"post\" utn=\"utn\"><div><input type=\"hidden\" name=\".m.\" value=\"hyoutei1\" /><input type=\"hidden\" name=\".i.\" value=\"$in{'i'}\" /><input type=\"hidden\" name=\".sakusen.\" value=\"4\" /><input type=\"hidden\" name=\".id.\" value=\"$in{'id'}\" /><input type=\"hidden\" name=\".pass.\" value=\"$in{'pass'}\" />
...
</select>$comrks$comrkk<input type=\"submit\" value=\"この案を選択\" /></div></form></td></tr>

<td>
『盟友救援』</td><td><form action=\"$COMMAND\" method=\"post\" utn=\"utn\"><div><input type=\"hidden\" name=\".m.\" value=\"hyoutei1\" /><input type=\"hidden\" name=\".i.\" value=\"$in{'i'}\" /><input type=\"hidden\" name=\".sakusen.\" value=\"11\" />
...
<td>
『停戦＆敵城攻略』</td><td><form action=\"$COMMAND\" method=\"post\" utn=\"utn\"><div><input type=\"hidden\" name=\".m.\" value=\"hyoutei1\" /><input type=\"hidden\" name=\".i.\" value=\"$in{'i'}\" /><input type=\"hidden\" name=\".sakusen.\" value=\"12\" />
...
<td>
『停戦＆税収アップ』</td><td><form action=\"$COMMAND\" method=\"post\" utn=\"utn\"><div><input type=\"hidden\" name=\".sakusen.\" value=\"13\" /><input type=\"hidden\" name=\".i.\" value=\"$in{'i'}\" /><input type=\"hidden\" name=\".m.\" value=\"hyoutei1\" /><input type=\"hidden\" name=\".i.\" value=\"$in{'i'}\" />
...
内政を重視し、自国の総収入を$mwyear年までに１．５倍以上にする。
<br />武将に対する所得税率：<select name=\".cno.\"><option value=\"61\">現状維持</option><option value=\"1\">1％</option><option value=\"5\">5％</option><option value=\"10\">10％</option><option value=\"15\">15％</option><option value=\"20\">20％</option>
</select>$comrks$comrkk<input type=\"submit\" value=\"この案を選択\" /></div></form></td></tr><tr>

<td>
『停戦＆盟友救援』</td><td><form action=\"$COMMAND\" method=\"post\" utn=\"utn\"><div><input type=\"hidden\" name=\".sakusen.\" value=\"14\" /><input type=\"hidden\" name=\".m.\" value=\"hyoutei1\" /><input type=\"hidden\" name=\".i.\" value=\"$in{'i'}\" />
