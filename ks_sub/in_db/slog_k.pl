...
require "./w_db/all2_kuni_db.pl";
	...
	open(IN,"./p_db/slogid/k_$in{'id'}.cgi");
	@S_MOVEPR = <IN>;
	close(IN);
$i = 0;
$i_max = $#S_MOVEPR;
...
<a href=\"./?.m.=p_k&amp;.tk.=$kuni_tenka_kaisuu&amp;.id.=$in{'id'}\">国家情報へ</a>
<table width=\"750\">
<tr><td class=\"txth\" width=\"88\"></td><td width=\"68\"></td><td class=\"txth\" width=\"165\"></td><td class=\"txth\" width=\"420\"></td></tr>
<tr class=\"bgc442200\"><td class=\"txth\" colspan=\"4\"><span class=\"cFFFFFF\">$k_name_d[$in{'id'}]戦争log（一覧表示）</span></tr>
$addc
</table>
